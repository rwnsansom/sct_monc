...
def create_dataset(member_key, ice=True, count=None):
    ...
    if ice:
        ...
        post_processed_ds.to_netcdf(f"{sct_dir}/combined_processed/ice/sct_{member_key}_pp.nc",mode="w")
    else:
...
if __name__=="__main__":
    #key_iterator = ['em3','em4','em5','em8', 'em9', 'em10','em15', 'em17', 'em20', 'em24', 'em30', 'em33', 'em35', 'em41', 'em49']
    # key_iterator = ['em1','em2','em6','em7','em11','em12','em13','em14','em16','em18','em19','em21','em22','em23','em25','em26','em27','em28','em29','em31','em32','em34','em36','em37','em38','em39','em40','em42','em43','em44','em45','em46','em47','em48','em50','em51','em52','em53','em54','em55','em56','em57','em58','em59','em60']
    ...
    with Pool(20) as p:
        p.map(create_dataset, key_iterator)